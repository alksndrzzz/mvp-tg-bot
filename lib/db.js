...
/**
 * Сохранить локацию
 * Примечание: chatId передается для логирования, но не сохраняется в БД
 * так как в таблице locations нет колонки chat_id
 */
async function saveLocation(chatId, driverId, lat, lon) {
  console.log('[saveLocation] Сохранение локации для driver_id:', driverId, 'chat_id:', chatId);
