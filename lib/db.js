 ...
 * - journey_start_date и journey_end_date установлены (не NULL)
...
function isNewRoute(driver) {
  ...
  // Проверяем новые колонки journey_*_date, если их нет - fallback на reminder_*_date
  // Это нужно для обратной совместимости, пока админка не переключится на journey_*_date
